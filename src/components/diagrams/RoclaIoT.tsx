export default function RoclaIoT() {
  return (
    <svg viewBox="0 0 400 225" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
      <text x="18" y="34" fontFamily="Inter, sans-serif" fontSize="8" fill="rgba(26,23,20,.5)" letterSpacing="1.2">
        AGV FLEET
      </text>
      ...
      <g stroke="rgba(26,23,20,.28)" strokeWidth="1" fill="none">
        ...
        <circle cx="200" cy="138" r="1.6" fill="rgba(26,23,20,.55)" stroke="none" />
        <circle cx="218" cy="144" r="1.6" fill="rgba(26,23,20,.55)" stroke="none" />
        <circle cx="236" cy="124" r="1.6" fill="rgba(26,23,20,.55)" stroke="none" />
        <circle cx="254" cy="132" r="1.6" fill="rgba(26,23,20,.55)" stroke="none" />
        <circle cx="270" cy="116" r="1.6" fill="#9c2b2b" stroke="none" />
      </g>
      <text x="180" y="95" fontFamily="Inter, sans-serif" fontSize="7" fill="rgba(26,23,20,.5)" letterSpacing="1.2">
        IOT DASHBOARD
      </text>
      ...
      <g stroke="#9c2b2b" strokeWidth="1" fill="none">
        ...
        <circle cx="354" cy="125" r="3" fill="#9c2b2b" stroke="none" />
      </g>
      <text x="333" y="114" fontFamily="Inter, sans-serif" fontSize="7" fill="#9c2b2b" letterSpacing="1.2">
        PREDICT
      </text>
      <text x="333" y="148" fontFamily="Inter, sans-serif" fontSize="7" fill="#9c2b2b" letterSpacing="1.2">
        MAINT.
      </text>
